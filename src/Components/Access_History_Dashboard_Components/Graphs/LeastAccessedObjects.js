...
class LeastAccessedObjects extends Component {
  ...
  render() {
    ...
    let data_container = this.props.bottom10_least_accessed_objects_data;
    ...
    const MyResponsiveBar = () => (
        <div id='least-accessed-objects-container'>
            <div id='least-accessed-objects' style={styles}>
                <h2>Least Accessed Objects</h2>
