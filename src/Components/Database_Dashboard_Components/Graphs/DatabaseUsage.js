...
class DatabaseUsage extends Component {
        render() {
            ...
            let layout = {
                title: 'Daily Gigabyte Usage by Database', autosize: true, "titlefont": { "size": 16, "color": "black" }, font: { size: 8, color: "black" }, legend: { "orientation": "h" }, yaxis: {
                    title: 'Gigabytes', titlefont: { size: 12, color: "black" }, automargin: true, showgrid: false, showline: true
                }, hovermode: "closest", hoverlabel: { namelength: -1 }, xaxis: { automargin: true, showgrid: false }
            };
